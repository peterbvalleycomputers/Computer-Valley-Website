...
- [x] Create React app structure (pages, auth context, API client)
- [x] Implement routes: Home, Login, Register, Admin
- [x] Implement protected admin route
- [x] Configure API base URL via Vite env
